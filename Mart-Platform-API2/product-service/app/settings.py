...
KAFKA_PRODUCT_CATEGORY_TOPIC = config("KAFKA_PRODUCT_CATEGORY_TOPIC", cast=str)


BOOTSTRAP_SERVER = config("BOOTSTRAP_SERVER", cast=str)

KAFKA_CONSUMER_GROUP_ID_FOR_PRODUCT = config("KAFKA_CONSUMER_GROUP_ID_FOR_PRODUCT", cast=str)
KAFKA_CONSUMER_GROUP_ID_FOR_PRODUCT_CATEGORY = config("KAFKA_CONSUMER_GROUP_ID_FOR_PRODUCT_CATEGORY", cast=str)
